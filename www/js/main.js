...
require([
  "swiper-bundle.min",			//スライダーJS
	...
	//.sliderBox--typeFlow02　流れるスライダー
	const slideLengthTypeFlow02 = document.querySelectorAll('.sliderBox--typeFlow02 .swiper-slide').length;
	const mySwiperTypeFlow02 = new Swiper('.sliderBox--typeFlow02 .swiper', {
	      slidesPerView: 'auto',
	      spaceBetween: 0,
	      loop: true,
	      loopAdditionalSlides: slideLengthTypeFlow01,
